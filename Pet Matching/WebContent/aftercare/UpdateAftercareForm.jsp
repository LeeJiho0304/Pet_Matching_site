...
<head>
    ...
    <title>Update AfterCare Form</title>
   <!-- BOOTSTRAP STYLES-->
          ...
          <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <form name="form" method="POST" action="<c:url value='/aftercare/update' />">
                        	<input type="hidden" name="pet_id" value="${pet_id}"/>
                        	<input type="hidden" name="owner_id" value="${owner_id}"/>
                        	<input type="hidden" name="app_id" value="${app_id}"/>
                        	<input type="hidden" name="ac_list_id" value="${aftercare.ac_list_id}"/>
                        	<input type="hidden" name="writer" value="${aftercare.writer}"/>
                            <table class="table table-striped table-bordered table-hover">
                                <tbody>
                                   <tr>
                                      <td>작성일</td>
                                      <td><input type="text" class="form-control" style="width:240" name="ac_list_date" value="${aftercare.ac_list_date}"></td>
                                   </tr>
                                   <tr>
                                      <td>제목</td>
                                      <td><input type="text" class="form-control" style="width:240" name="ac_list_title" value="${aftercare.ac_list_title}"></td>
                                   </tr>
                                   <tr>
                                      <td colspan="2">
                                         <p><textarea cols="240" rows="20" class="form-control" style="width:240" name="ac_list_content">${aftercare.ac_list_content}</textarea></p>
                                      </td>
                                   </tr>
                                   <tr>
                                      <td colspan="2" align=center>
                                      <input type="button" class="btn btn-primary" value="수정" onClick="submit()">
                                      <input type="button" class="btn btn-default" value="뒤로가기" onClick="goBack('<c:url value='/aftercare/content'>
