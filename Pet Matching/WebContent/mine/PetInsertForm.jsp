          ...
          <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">                  
                        <!-- registration form  -->		              
						<form name="form" method="POST" action="<c:url value='/mine/pet/insert' />">						    
						       <table class="table table-striped table-bordered table-hover">
						       <thead>
                                   	<tr>
                                       <td>펫 이름</td>
                                       <td>
                                          <input type="text" class="form-control" style="width:240" name="pet_name">
                                       </td>
                                   	</tr>
                               </thead>
						       <tbody>
                                       ...
                                       <td>펫 종류</td>
                                       <td>
                                          <input type="text" class="form-control" style="width:240" name="kinds">
                                       </td>
                                   	</tr>
                                   	<tr>
                                       <td>펫 품종</td>
                                       <td>
                                          <input type="text" class="form-control" style="width:240" name="race">
                                       </td>
                                   	</tr>
                                   	<tr>
                                       <td>펫 나이</td>
                                       <td>
                                          <input type="text" class="form-control" style="width:240" name="age">
                                       </td>
                                   	</tr>
                                   	<tr>
                                       <td>펫 성별</td>
                                       <td>
                                          <input type="text" class="form-control" style="width:240" name="pet_gender">
                                       </td>
                                   	</tr>
                                   	<tr>
                                       <td>예방 접종</td>
                                       <td>
                                          <input type="text" class="form-control" style="width:240" name="vaccine">
                                       </td>
                                   	</tr>
                                   	<tr>
                                       <td>최근 진료 날짜</td>
                                       <td>
                                          <input type="text" class="form-control" style="width:240" name="diagnosis_date">
                                       </td>
                                   	</tr>
                                    <tr>
                                       <td>가격</td>
                                       <td>
                                          <input type="text" class="form-control" style="width:240" name="price">
                                       </td>
                                   	</tr>
                                    <tr>
