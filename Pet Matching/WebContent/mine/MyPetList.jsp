                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li class="active-link">
                        <a href="<c:url value='/mine/mypage'>
                     		</c:url>"><i class="fa fa-user "></i>마이 페이지<hr><i class="fa fa-paw " aria-hidden="true"></i>내 펫 관리 </a>
                    </li>
                    <li> 
	                            ...
	                            <c:forEach var="pet" items="${pet_list}">
                               	<tr>
                                    ...
                                    <td><a href="<c:url value='/mine/pet/update/form'> 
		                                    <c:param name='pet_id' value='${pet.pet_id}'/>
		                                 	</c:url>" class="btn btn-default" onclick="return callupdate();">수정</a></td>
                                    <td><a href="<c:url value='/mine/pet/delete'> 
                                    		<c:param name='pet_id' value='${pet.pet_id}'/>
                                 			</c:url>" class="btn btn-danger" onclick="return calldelete();">삭제</a></td>
                                </tr>
                            	</c:forEach>
                            	<tr>
                            		<td colspan="6" align="right">
	                                    <a href="<c:url value='/mine/pet/insert/form'>
	                                 		</c:url>"  class="btn btn-primary">등록</a>
	                                    <a href="<c:url value='/mine/mypage'>
