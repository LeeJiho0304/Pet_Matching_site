...
<head>
    ...
    <title>Recommend NoticeBoard Content</title>
   <!-- BOOTSTRAP STYLES-->
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
          	<div id="page-inner">
                ...
                <!-- /. ROW  -->
                <hr>
                <font color="blue"><h4><c:out value="${curUserId} 회원님의 성향을 파악 한 결과, 아래의 게시글을 추천 드립니다*^^* " /></h4></font>
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            	<% int i = 1; %>
                               	<c:forEach var="content" items="${rec_content_list}">
                                <tr>
                                    <td><% out.print(i); i++; %></td>
                                    <td>
