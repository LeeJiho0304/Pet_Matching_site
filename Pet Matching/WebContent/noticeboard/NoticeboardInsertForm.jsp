...
<title>NoticeBoard Insert Form</title>
  <!-- BOOTSTRAP STYLES-->
                ...
                <ul class="nav" id="main-menu">
                   	<li class="active-link">
                        <a href="<c:url value='/noticeboard/list'>
                     		</c:url>" ><i class="fa fa-desktop "></i>전체 게시판 보기<hr><i class="fa fa-plus " aria-hidden="true"></i>게시글 작성 </a>
                    </li>
                    <li>
                    ...
                    <li>
                       	<form name="form" method="POST" action="<c:url value='/noticeboard/insert' />" >
                      ...
                      <form name="form" method="POST" action="<c:url value='/noticeboard/insert' />">
                         <table class="table table-striped table-bordered table-hover">
                             <tbody>
                                 ...
                                 <tr>
                                   <td>제목</td>
                                   <td><input type="text" class="form-control" style="width:240" name="list_title"></td>
                                </tr>
                                 <tr>
                                   <td>작성일</td>
                                   <td><input type="text" class="form-control" style="width:240" name="list_date"></td>
                                </tr>
                                <tr>
                                   <td>펫 선택</td>
                                   <td><select name="pet_id">
		                                   <option value="default" selected>없음</option>
                                ...
                                <tr>
                                   <td colspan="2">
                                      <p><textarea cols="240" rows="20" class="form-control" style="width:240" name="list_content"></textarea></p>
                                   </td>
                                </tr>
                                <tr>
                                   <td colspan="2" align=center>
	                                   <input type="button" class="btn btn-primary" value="등록" onClick="submit()">
	                                   <input type="button" class="btn btn-default" value="뒤로가기" onClick="goBack('<c:url value='/noticeboard/list' />')"> &nbsp;
                                   </td>
                                </tr>
                             </tbody>
                         </table>
